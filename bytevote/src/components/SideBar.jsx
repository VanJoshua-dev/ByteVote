...
//               <li>
//                 <Link to="/" className={clsx("flex items-center space-x-3 hover:bg-gray-700 p-2 rounded-md cursor-pointer", { "bg-gray-700": location.pathname === "/dashboard" })}>
//                   <Home />
...
//             <ul className="space-y-2 mt-2">
//               <li>
//                 <Link to="/election-history" className={clsx("flex items-center space-x-3 hover:bg-gray-700 p-2 rounded-md cursor-pointer", { "bg-gray-700": location.pathname === "/election-history" })}>
//                   <Archive />
...
//             <ul className="space-y-2 mt-2">
//               <li>
//                 <Link to="/start-election" className={clsx("flex items-center space-x-3 hover:bg-gray-700 p-2 rounded-md cursor-pointer", { "bg-gray-700": location.pathname === "/start-election" })}>
//                   <PlayCircle />
